document.addEventListener("DOMContentLoaded", function(){
    ...
    const totalSlides = 4;
    const linkUrls = [
        "https://example.com/slide1","https://example.com/slide2",
        "https://example.com/slide3","https://example.com/slide4"];
    ...
    function animateSlideTransition(currentSlide, nextSlide, direction) {
        ...
        gsap.set(nextSlide,{
            clipPath: direction === "up" ? "polygon(0 0, 100% 0, 100% 0, 0 0)" : "polygon(0 100%, 100% 100%, 100% 100%, 0 100%)",
        });
        ...
        timeline.to(currentImg, {
            ...
            clipPath: "polygon(0 0, 100% 0, 100% 100%, 0 100%)",
            duration: 2,
            ease: "power4.inOut",},0).to(nextImg, {
            scale: 1,
            top: "0",
            duration: 2,
            ease: "power3.inOut",});
    ...
    function updateSlideTitle(slideIndex) {
        const displayTitle = normalizeSlideTitle(slideIndex);
    ...
    const num = parseInt(slide.id.replace("slide-", ""));
    if (Math.abs(num - currentSlideIndex) > 2) {
        slide.remove();
    }
});
    ...
    function getImageSource(slideNumber) {
        return `./images/image${normalizeSlideTitle(slideNumber)}.jpg`;
    }
